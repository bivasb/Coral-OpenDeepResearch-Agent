...
i. Run [Coral Server](https://github.com/Coral-Protocol/coral-server) (Expand drop-down below)
<details>
...
ii. Run [Interface Agent](https://github.com/Coral-Protocol/Coral-Interface-Agent)
<details>
